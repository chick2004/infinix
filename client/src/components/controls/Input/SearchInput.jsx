...
export function SearchInput({ defaultValue = "", disable = false, placeholder, onChange, onSearch }) {
    ...
    return (
        <div className={styles.input_group}>
            <input type="search" value={value} disabled={disable} placeholder={placeholder} onChange={handleChange}/>
